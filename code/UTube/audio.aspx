<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="audio.aspx.cs" Inherits="UTube.audio" %>
...
<body>
            ...
            <div id="content-area">
                ...
                <div id="profile">
                    <div class="left-bar">
                        ...
                        <div id="recent-Audios" class="left-250 gray-back round-corner">
                            <asp:TextBox ID="tbAudios" runat="server" CssClass="hidden"></asp:TextBox>
                            <span class="head-text"><i class="n2r-music"></i>Related audio</span><br />
                    ...
                    <div class="right-bar">
                        <div class="right-840">
                            <div id="vid-play">
                                ...
                                <audio id="play-audio" autoplay="autoplay" controls>
                                    <source src="sality.ogg" type="audio/ogg">
                                    <source src="sality.mp3" type="audio/mpeg">
    ...
    <script>
        $(document).ready(function () {
            ...
            var jsonx = JSON.parse($('#tbAudios').val());
            for (var i = 0; i < jsonx.length; i++) {
                var temp = '<div class="related-aud-thread"><a class="aud-link" href="audio.aspx?listen=' + jsonx[i].Path + '">' + jsonx[i].upName + '</a><br />';
                temp += 'By <a href="channel.aspx?rel=' + jsonx[i].usID + '">' + jsonx[i].Name + '</a><br/>';
                temp += 'viewe(s) : ' + jsonx[i].Views + '&nbsp; | &nbsp; ' + jsonx[i].Time + '</div><hr />';
                $('#recent-Audios').append(temp);
            }
        });
