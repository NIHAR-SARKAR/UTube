<%@ Page Title="" Language="C#" MasterPageFile="~/profile.Master" AutoEventWireup="true" CodeBehind="history.aspx.cs" Inherits="UTube.WebForm3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="seb-list">
        <asp:TextBox ID="tbHistory" runat="server" CssClass="hidden"></asp:TextBox>
        <center>
            <h3>History</h3>
            <asp:Button ID="btnClearHistory" runat="server" Text="Clear History" CssClass="theme-btn-1" OnClick="btnClearHistory_Click" />
        </center>
        
    </div>

    <script>
        var data = JSON.parse($('#ContentPlaceHolder1_tbHistory').val());
